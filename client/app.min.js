...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var n=t[a];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,a,n){return a&&e(t.prototype,a),n&&e(t,n),t}}(),__UploadSchematicItem_Template=null,UploadSchematicItem=function(){function e(t,a){var n=this;arguments.length<=2||void 0===arguments[2]?!1:arguments[2];if(_classCallCheck(this,e),!e.Template)throw new Error("Unloaded template data.");this.newFilename=null,this.template=$(e.Template.clone()),arguments.length>0&&(this.Id=t),arguments.length>1&&(this.filedata=a,this.Filename=a.name),arguments.length>2&&(this.isDuplicateFile=!1),$("input[name=title]",this.template).on("blur keypress keyup",function(e){return n.handleTitleValidate(e)}),$("button.upload",this.template).on("click",function(e){return n.handleUploadButtonClick(e)}),$("button.cancel",this.template).on("click",function(e){return n.handleCancelButtonClick(e)})}return _createClass(e,null,[{key:"loadSUITemplate",value:function(){axios("./sch-upload-item-template.html?"+Date.now()).then(function(t){e.Template=$($(t.data).get(0))})}},{key:"Template",get:function(){return __UploadSchematicItem_Template},set:function(e){__UploadSchematicItem_Template=e}}]),_createClass(e,[{key:"getJQueryObject",value:function(){return this.template.data("id",this.Id),$("p.filename strong",this.template).text(escapeHtml(this.Filename)),$(".form-group.title label",this.template).attr("for",this.Id+"-title"),$(".form-group.title input",this.template).attr("id",this.Id+"-title"),$(".form-group.description label",this.template).attr("for",this.Id+"-description"),$(".form-group.description textarea",this.template).attr("id",this.Id+"-description"),$(".form-group.delete-key label",this.template).attr("for",this.Id+"-delete-key"),$(".form-group.delete-key input",this.template).attr("id",this.Id+"-delete-key"),$("input[name=title]",this.template).trigger("blur"),this.template}},{key:"handleTitleValidate",value:function(){this.Title.length>0?($(".form-group.title",this.template).removeClass("has-danger"),$("input[name=title]",this.template).removeClass("form-control-danger"),$("button.upload",this.template).removeAttr("disabled")):($(".form-group.title",this.template).addClass("has-danger"),$("input[name=title]",this.template).addClass("form-control-danger"),$("button.upload",this.template).attr("disabled","disabled"))}},{key:"handleCancelButtonClick",value:function(){var e=this;setTimeout(function(){return e.template.trigger("schup:uploaded",{id:e.id})},50)}},{key:"handleUploadButtonClick",value:function(){var e=this;$("button",this.template).attr("disabled","disabled");var t={title:this.Title,description:this.Description},a=this.DeleteKey;a&&""!=a&&(t.delete_key=getHashedDeleteKey(a)),schematicsAPI.uploadFile(this.filedata,t,function(t){t?($("button",e.template).removeAttr("disabled"),e.template.trigger("schup:uploaderror",{id:e.id,Error:t})):e.template.trigger("schup:uploaded",{id:e.id,title:e.Title,filename:e.Filename})})}},{key:"setEventCancel",value:function(e){this.template.on("schup:canceled",e)}},{key:"setEventUploaded",value:function(e){this.template.on("schup:uploaded",e)}},{key:"setEventUploadError",value:function(e){this.template.on("schup:uploaderror",e)}},{key:"Id",set:function(e){this.id=e},get:function(){return this.id}},{key:"Filename",set:function(e){this.newFilename=e},get:function(){return this.newFilename?this.newFilename:this.filedata.name}},{key:"Title",get:function(){return $("input[name=title]",this.template).val()}},{key:"Description",get:function(){return $("textarea[name=description]",this.template).val()}},{key:"DeleteKey",get:function(){return $("input[name=delete_key]",this.template).val()}},{key:"isDuplicateFile",set:function(){}}]),e}();UploadSchematicItem.loadSUITemplate();var DragAndDropUploader=function(){function e(){_classCallCheck(this,e),this.schUploadItemTemplate=null,this.uploadFilesCache=[]}return _createClass(e,[{key:"handleFileSelect",value:function(e){e.target.className="",e.stopPropagation(),e.preventDefault();for(var t,a=0;t=e.originalEvent.dataTransfer.files[a];a++)this.uploadFilesCache.push(t);this.renderOutput()}},{key:"handleDragOver",value:function(e){e.target.className="hover",e.stopPropagation(),e.preventDefault(),e.originalEvent.dataTransfer.dropEffect="link"}},{key:"handleDragLeave",value:function(){this.className=""}},{key:"initializer",value:function(){var e=this,t=$("#drop-zone");t.on("dragover",function(t){return e.handleDragOver(t)}),t.on("dragleave",function(t){return e.handleDragLeave(t)}),t.on("drop",function(t){return e.handleFileSelect(t)})}},{key:"renderOutput",value:function(){for(var e,t=this,a=[],n=0;e=this.uploadFilesCache[n];n++){var l=new UploadSchematicItem(n,e);l.setEventCancel(function(e,a){t.uploadFilesCache.splice(a.id,1),t.renderOutput()}),l.setEventUploaded(function(e,a){SchematicsListController.ReloadList(),t.uploadFilesCache.splice(a.id,1),t.renderOutput(),swal(a.title+"のアップロードが完了しました","","success")}),a.push(l.getJQueryObject())}$("output#list").html('<ul class="container-fluid"></ul>'),$("output#list ul").append(a)}}]),e}(),dadUploader=new DragAndDropUploader;dadUploader.initializer();
"use strict";function getHashedDeleteKey(e){for(var t=CryptoJS.SHA256(e),a="",n=0;n<t.words.length;n++)a+=(t.words[n]>>>0).toString(16);return a}function escapeHtml(e){var t={"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"};return e.replace(/[&"<>]/g,function(e){return t[e]})}function getDateStringFromUTCMillis(e){var t=new Date(e);return[t.getFullYear(),t.getMonth()+1,t.getDate()].join("/")+" "+t.toLocaleTimeString()}
;"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function startUTDisplay(){null==schUTUpdateTimer&&(schUTUpdateTimer=setInterval(function(){if(lastUpdateTime<1)schUTDisplay.textContent="";else if(Date.now()-lastUpdateTime>36e5)schUTDisplay.innerHTML='<span class="text-warning">下記のリストは1時間以上更新されていません。</span>',clearInterval(schUTUpdateTimer),schUTUpdateTimer=null;else{var e=Math.floor((Date.now()-lastUpdateTime)/1e3);e>300?e='<span class="text-warning">'+e+"秒</span>":e+="秒",schUTDisplay.innerHTML="最終更新から "+e+" 経過しています。"}},500))}var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var n=t[a];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,a,n){return a&&e(t.prototype,a),n&&e(t,n),t}}();$("#sch-files").bootstrapTable({toolbar:"#sch-toolbar",sortName:"modified_date",sortOrder:"desc",pagination:!0,search:!0,onResetView:function(){new Clipboard(".sch-command-copy",{text:function(e){return"//schem load "+$(e).data("filename")}}),$(".sch-file-delete").on("click",function(){var e=this;swal({title:"削除確認",text:"<strong>"+$(this).data("filename")+'</strong>を削除してもよろしいですか？<p><small style="font-size:9pt">※ 未記入の場合は削除キー未登録のアイテムのみ削除できます。</small></p>',type:"input",html:!0,customClass:"sa-delete-key-input",showCancelButton:!0,cancelButtonText:"キャンセル",confirmButtonColor:"#DD6B55",confirmButtonText:"削除するよ!",inputPlaceholder:"削除キーを入力してください。"},function(t){0!=t&&schematicsAPI.deleteFile($(e).data("filename"),t,function(t,a){setTimeout(function(){t?swal($(e).data("filename")+"の削除に失敗しました","挙動おかしい時は鯖管に教えてあげてね","error"):(swal(a.data.file.filename+"を削除しました","","success"),SchematicsListController.ReloadList())},500)})})})},columns:[{title:"名前",field:"title",sortable:!0},{title:"ファイル名",field:"filename","class":"small",sortable:!0},{title:"更新日時",field:"modified_date","class":"small",sortable:!0,formatter:function(e){return!e||1>e?"":getDateStringFromUTCMillis(e)}},{title:"詳細",field:"description","class":"small"},{title:"操作",field:"dropdown",formatter:function(e,t){var a=$("<div></div>");return a.append('<div class="btn-group btn-group-sm"></div>'),$(".btn-group",a).append('<button type="button" class="btn btn-secondary btn-no-outline sch-command-copy" data-filename="'+t.filename+'"><small>コマンドをコピー</small><i class="fa fa-clipboard" aria-hidden="true"></i></button>'),$(".btn-group",a).append('<button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="sr-only">Toggle Dropdown</span></button>'),$(".btn-group",a).append('<div class="dropdown-menu"></div>'),$(".dropdown-menu",a).append('<h6 class="dropdown-header">その他操作</h6>'),$(".dropdown-menu",a).append('<a class="dropdown-item" href="'+schematicsAPI.getDownloadURL(t.filename)+'">ダウンロード <i class="fa fa-download" aria-hidden="true" /></a>'),$(".dropdown-menu",a).append('<a class="dropdown-item sch-file-delete" href="#" data-filename="'+t.filename+'">削除 <i class="fa fa-trash" aria-hidden="true" /></a>'),a.html()}}],onRefresh:function(){schematicsAPI.reload(function(e,t){SchematicsListController.UpdateData(t),lastUpdateTime=Date.now(),startUTDisplay()})}});var schUTDisplay=$("#sch-toolbar > span.updated-time")[0],schUTUpdateTimer=null,SchematicsListController=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"TableInitialize",value:function(){e.ReloadList(),$("#sch-toolbar > button.refresh").on("click",function(){$("#sch-toolbar > button.refresh").attr("disabled","disabled"),e.ReloadList(),setTimeout(function(){return $("#sch-toolbar > button.refresh").removeAttr("disabled")},1e3)})}},{key:"ReloadList",value:function(){$("#sch-files").bootstrapTable("refresh")}},{key:"UpdateData",value:function(e){var t=$("#sch-files");t.bootstrapTable("removeAll"),e.forEach(function(e){t.bootstrapTable("append",Object.assign({title:"",filename:"",upload_date:0,description:"",dropdown:""},e))})}}]),e}();SchematicsListController.TableInitialize();
